...
//userName(string),userId(int),lat(float),lng(float)を渡す(二重IDはエラー)
// $Yam -> resisterUser("Kawakami",2,35.0,139.0);
//userId,時間を二進数チックのやつを渡す(誰に入れるかuserIdを揃える)
$Yam->addUserTimeValue("2",0b000011111111111111111111);
// 日数の状態()にはuserIdが入る
$Yam->addTotalDelivaryDays("2");
$Yam->addUseAppDays("2");
