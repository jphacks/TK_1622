 ...
 */
public class TimePickerDialogFragmentD2 extends DialogFragment implements TimePickerDialog.OnTimeSetListener {
    ...
    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
        ...
        editortp.putString("time2d", String.valueOf(hourOfDay) + ":" +String.valueOf(minute));
        editortp.apply();
